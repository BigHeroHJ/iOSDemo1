...
- (void)testSignal
{
    self.sendSemaphore = dispatch_semaphore_create(3);
...
//    dispatch_semaphore_signal(self.commandSemaphore);
    ...
    long st = dispatch_semaphore_wait(self.fullSendSemaphore,dispatch_time(DISPATCH_TIME_NOW, 10220*NSEC_PER_MSEC));
    NSLog(@"1");
    long st1 = dispatch_semaphore_wait(self.fullSendSemaphore,dispatch_time(DISPATCH_TIME_NOW, 10220*NSEC_PER_MSEC));
     NSLog(@"1");
//    long st2 = dispatch_semaphore_wait(self.commandSemaphore,DISPATCH_TIME_FOREVER);
//     NSLog(@"1");
//    long st3 = dispatch_semaphore_wait(self.commandSemaphore,DISPATCH_TIME_FOREVER);
//     NSLog(@"1");
//    __block  long x, y ,z ;
